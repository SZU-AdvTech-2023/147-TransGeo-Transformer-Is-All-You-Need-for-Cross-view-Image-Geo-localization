...
input_dir = '/data1/lingxingtao/Dataset/CVUSA/bingmap/19/'
output_dir = '/data1/lingxingtao/Dataset/CVUSA/polarmap/19/'
...
for img in images:
    ...
    imageio.imsave(output_dir + img.replace('jpg', 'png'), image)
